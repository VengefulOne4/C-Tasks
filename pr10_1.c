...
{
	struct TZlomok z1, z2, sucin_zlomkov, sucet_zlomkov, podiel_zlomkov, rozdiel_zlomkov;
	struct TZlomok* pz1, * pz2, * p_sucin_zlomkov, * p_sucet_zlomkov, *p_podiel_zlomkov, *p_rozdiel_zlomkov;
